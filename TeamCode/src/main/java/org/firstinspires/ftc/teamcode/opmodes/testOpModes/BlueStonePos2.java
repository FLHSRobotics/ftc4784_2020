...
@Autonomous
public class BlueStonePos2 extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory t5 = drivetrain.trajectoryBuilder(t4.end())
                .lineToLinearHeading(new Vector2d(-65.0,38.0), Math.toRadians(-90))
                .build();

        //stone4
        Trajectory stone5Pick = drivetrain.trajectoryBuilder(t5.end())
                .lineTo(new Vector2d(-66,26), DriveConstants.STONE_CONSTRAINTS)
                .addDisplacementMarker(clawSubsystem::pick)
                .build();
        Trajectory stone5Move = drivetrain.trajectoryBuilder(stone5Pick.end())
                .lineTo(new Vector2d(-65,33))
                .build();
        Trajectory stone5Trans = drivetrain.trajectoryBuilder(stone5Move.end())
                .lineToLinearHeading(new Vector2d(-60,33), Math.toRadians(2),DriveConstants.STONE_CONSTRAINTS)
                .build();
