...
@Autonomous
public class RedStonePos1 extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory t5 = drivetrain.trajectoryBuilder(t4.end())
                .lineToSplineHeading(new Vector2d(-35.0,-35.0), Math.toRadians(90))
                .build();

        //stone4
        Trajectory stone4Pick = drivetrain.trajectoryBuilder(t5.end())
                .lineTo(new Vector2d(-62.0,-24.0))
                .addDisplacementMarker(clawSubsystem::pick)
                .build();
        Trajectory stone4Move = drivetrain.trajectoryBuilder(stone4Pick.end())
                .lineTo(new Vector2d(-62.0,-29))
                .build();
        Trajectory stone4Trans = drivetrain.trajectoryBuilder(stone4Move.end())
                .lineToLinearHeading(new Vector2d(-60,-29), Math.toRadians(10.0),DriveConstants.STONE_CONSTRAINTS)
                .build();
